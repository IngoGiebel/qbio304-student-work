...
Figure \ref{fig:2.1-TPM-Stats} shows some basic transcripts per million (TPM\index{transcript!TPM}) statistics about the imported kallisto files.
...
For further analysis, \verb|DGEList|-objects with counts per million (CPM\index{CPM}) and log2(CPM) values were created using the R-package \verb|edgeR|\index{R!package!edgeR} \autocite{R-edgeR, edgeR2010}. Figure \ref{fig:2.2-Log2CPM-unflt-notnorm} shows the distribution of the log2(CPM) values.
